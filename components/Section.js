export default class Section {
  ...
  _setSectionAttributes() {
    this._element = document.querySelector('#project-section').content.cloneNode(true);
    this._elementTitle = this._element.querySelector('.project-section__title');
    this._elementSubtitle = this._element.querySelector('.project-section__subtitle');
    this._container = this._element.querySelector('.project-section__container');
